	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen p-5">
		<div class="modal-content rounded-4">
			<div class="modal-header px-md-5 py-md-4 mt-2 mb-3 shadow-sm border-0">
				<h3 class="h5 fw-extrabold mb-0">Choose Layouts Customer_Home</h3>
...
$.notify({
	icon: 'icon-bell',
	title: 'Kaiadmin',
	message: 'Premium Bootstrap 5 Admin Customer_Home',
},{
	type: 'secondary',
	placement: {
		from: "bottom",
